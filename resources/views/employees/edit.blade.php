...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Event: Region inabadilika
    regionSelect.addEventListener('change', function () {
        populateDistricts(this.value);
        wardSelect.innerHTML = '<option value="">Select Ward</option>';
    });

    // Event: District inabadilika
    districtSelect.addEventListener('change', function () {
        populateWards(this.value);
    });

    // On load — kama region ipo, populate districts
    if (regionSelect.value) {
        populateDistricts(regionSelect.value, oldDistrictId);
    }

    // On load — kama district ipo, populate wards
