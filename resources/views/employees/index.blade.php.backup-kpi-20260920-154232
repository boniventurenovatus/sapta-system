...
<div class="em-page">
            ...
            <form method="GET" action="{{ url('/employees') }}" class="em-filter">
                ...
                <div class="em-form-group">
                    ...
                    <div class="em-input-wrap">
                        ...
                        <select name="department" class="em-input">
    ...
    <div class="em-card">
        <div class="em-card-head">
            <h2><i class="fas fa-list"></i> Employee List <span style="color:#64748b; font-weight:500; margin-left:0.5rem;">({{ $employees->total() ?? 0 }})</span></h2>
        </div>
                    ...
                    <tbody>
                        @foreach($employees as $emp)
                            <tr>
                                ...
                                <td class="col-status">
                                    <span class="badge badge-{{ $emp->status === 'active' ? 'success' : ($emp->status === 'on_leave' ? 'warning' : 'secondary') }}">
                                        {{ ucfirst(str_replace('_', ' ', $emp->status ?? 'active')) }}
                                    </span>
                                </td>
                                <td class="col-actions">
                                    <div class="actions">
                                        <a href="{{ url('/employees/' . $emp->id) }}" class="action-btn view"><i class="fas fa-eye"></i></a>
                                        <a href="{{ url('/employees/' . $emp->id . '/edit') }}" class="action-btn edit"><i class="fas fa-pen"></i></a>
