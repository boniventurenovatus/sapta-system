                            ...
                            <td style="padding: 0.75rem 1rem;">
                                <div style="display: flex; gap: 0.5rem;">
                                    ...
                                    @if($emp->employment_status === 'active')
                                        <form method="POST" action="{{ route('employees.suspend', $emp->id) }}" style="display:inline;" onsubmit="return saptaFormConfirm(event, 'Are you sure?')">
                                            @csrf
                                    ...
                                    {{-- Deactivate --}}
                                    @if($emp->employment_status === 'active')
                                        <form method="POST" action="{{ route('employees.deactivate', $emp->id) }}" style="display:inline;" onsubmit="return saptaFormConfirm(event, 'Are you sure?')">
                                            @csrf
