...
<div class="rpv-page">
    <div class="rpv-head">
        ...
        <a href="{{ route('reports.export.payment-vouchers') }}" style="padding:0.6rem 1rem; background:#10b981; color:#fff; border:none; border-radius:0.5rem; text-decoration:none; font-weight:700;"><i class="fas fa-file-csv"></i> CSV</a>
            <button onclick="window.print()" class="rpv-btn rpv-btn-primary"><i class="fas fa-print"></i> Print</button>
        </div>
    </div>
