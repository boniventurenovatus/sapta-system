...
<div class="filter-card" style="background:#fff; border-radius:16px; border:1px solid #e8ecf1; padding:20px 24px; margin-bottom:20px; box-shadow:0 2px 8px rgba(0,0,0,0.04);">
    ...
    <form method="GET" action="{{ route('reports.projects') }}">
        <div style="display:grid; grid-template-columns:1fr 1fr 1fr auto; gap:16px; align-items:end;">
            <div>
    <label style="display:block; font-size:11px; font-weight:700; color:#4a5a6f; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:6px;">Status</label>
    <select name="status" style="width:100%; padding:10px 14px; border:1.5px solid #e8ecf1; border-radius:10px; font-size:14px; background:#fff;">
...
<div>
    <label style="display:block; font-size:11px; font-weight:700; color:#4a5a6f; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:6px;">Priority</label>
    <select name="priority" style="width:100%; padding:10px 14px; border:1.5px solid #e8ecf1; border-radius:10px; font-size:14px; background:#fff;">
        ...
        <option value="critical" @selected(request('priority') == 'critical')>Critical</option>
            ...
            <div style="display:flex; gap:8px;">
                ...
                <a href="{{ route('reports.projects') }}" style="padding:10px 20px; border-radius:10px; font-weight:700; font-size:13px; background:#fff; color:#4a5a6f; border:1.5px solid #e8ecf1; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
