            ...
            <div class="employee-form-grid">
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="first_name"
                        name="first_name"
                        value="{{ old('first_name', $employee- required>first_name) }}"
                        required
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="middle_name"
                        name="middle_name"
                        value="{{ old('middle_name', $employee- required>middle_name) }}"
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="last_name"
                        name="last_name"
                        value="{{ old('last_name', $employee- required>last_name) }}"
                        required
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="date_of_birth"
                        name="date_of_birth"
                        value="{{ old('date_of_birth', $employee- required>date_of_birth?->format('Y-m-d')) }}"
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="email"
                        name="email"
                        value="{{ old('email', $employee- required>email) }}"
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="phone"
                        name="phone"
                        value="{{ old('phone', $employee- required>phone) }}"
                    >
                ...
                <div class="employee-form-group full-width">
                    ...
                    <input
                        ...
                        id="address"
                        name="address"
                        value="{{ old('address', $employee- required>address) }}"
                    >
            ...
            <div class="employee-form-grid">
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        value="{{ old('employee_number', $employee- required>employee_number) }}"
                        required
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="job_title"
                        name="job_title"
                        value="{{ old('job_title', $employee- required>job_title) }}"
                    >
                ...
                <div class="employee-form-group">
                    ...
                    <input
                        ...
                        id="hire_date"
                        name="hire_date"
                        value="{{ old('hire_date', $employee- required>hire_date?->format('Y-m-d')) }}"
                    >
        ...
        <div class="employee-form-card">
            ...
            <div class="employee-form-group">
                ...
                <textarea
                 ...
                 required>{{ old('notes', $employee->notes) }}</textarea>
